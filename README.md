...
Во всех примерах ниже базовый URL — локальный: http://localhost:8090/api/.
Для продакшн-сервера нужно заменить http://localhost:8090 на http://89.169.177.182:8090.
